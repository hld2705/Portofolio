...
function joinTemplate() {
    return ` <div class="project-parent-div">
            ...
            <div class="project-details-pictures-div">
                ...
                <a class="projects-text-direction" href="https://join.halid-crnkic.at/" target="_blank"><div class="projects-live-test-button"><p class="projects-live-test-button-text">Live Test</p></div></a>
                <a class="projects-text-direction projects-github-button-text" href="https://github.com/hld2705/Join" target="_blank"><div class="projects-github-button"><p class="projects-github-button-text">GitHub</p></div></a>
                </div>
                </div>
            </div>
        </div>`
...
function elPolloLocoTemplate() {
    return `<div class="project-parent-div">
        ...
        <div class="project-details-pictures-div">
            ...
            <div class="projects-pictures-buttons">
                <a class="projects-text-direction" href="https://elpolloloco.halid-crnkic.at/" target="_blank"><div class="projects-live-test-button"><p class="projects-live-test-button-text">Live Test</p></div></a>
                <a class="projects-text-direction" href="https://github.com/hld2705/El-Pollo-Loco" target="_blank"><div class="projects-github-button"><p class="projects-github-button-text">GitHub</p></div></a>
            </div>
            </div>
        </div>
        </div>`
...
function pokeDexTemplate() {
    return `<div class="project-parent-div">
        ...
        <div class="project-details-pictures-div">
            ...
            <div class="projects-pictures-buttons">
                <a class="projects-text-direction" href="https://pokedex.halid-crnkic.at/" target="_blank"><div class="projects-live-test-button"><p class="projects-live-test-button-text">Live Test</p></div></a>
                <a class="projects-text-direction" href="https://github.com/hld2705/PokeDex" target="_blank"><div class="projects-github-button"><p class="projects-github-button-text">GitHub</p></div></a>
            </div>
        </div>
            </div>
        </div>`
    ...
    return `<div class="project-details-placement-div">
                <div class="projects-details-descreption-div">
                    <div class="project-details-description-section">
                        ...
                        <div class="projects-pictures-buttons">
                            <a class="projects-text-direction" href="https://join.halid-crnkic.at/" target="_blank"><div class="projects-live-test-button"><p class="projects-live-test-button-text">Live Test</p></div></a>
                            <a class="projects-text-direction" href="https://github.com/hld2705/Join" target="_blank"><div class="projects-github-button"><p class="projects-github-button-text">GitHub</p></div></a>
                        </div> 
                    </div>
                </div>
            </div>`;
